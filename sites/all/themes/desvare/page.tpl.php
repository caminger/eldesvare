...
?>
  ...
  <div id="page" class="page">
    ...
    <?php print render($page['header_top2']); ?>
...
<script src="/misc/ui/jquery.ui.autocomplete.min.js"></script>
<script src="/sites/all/themes/desvare/jquery.mousewheel.min.js"></script>
<!-- custom scrollbars plugin -->
<script src="/sites/all/themes/desvare/jquery.mCustomScrollbar.js"></script>
<script>
	(function($){
		$(window).load(function(){
			$("#block-views-recomendados-block_1 .inner").mCustomScrollbar();
			$("#block-multiblock-1 .inner").mCustomScrollbar();
		});
	})(jQuery);
</script>